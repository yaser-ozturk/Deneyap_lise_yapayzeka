...
model_sonuc.input['bulaşık miktarı'] = 50   #  NORMAL 0.36     # normal ve çok = uzun 
model_sonuc.input['kirlilik seviyesi']= 80  # çok 0.5
model_sonuc.compute()  # 0.36 * 110  / 0.36 = 110    
print (model_sonuc.output['yıkama süresi']) ## 113.76 dk çalışşşşş 