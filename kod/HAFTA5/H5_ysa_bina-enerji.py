from keras.models import Sequential # Boş yapay sinir agı modeli icin
from keras.layers import Dense      
from tensorflow.keras.layers import Dense, Input, Dropout  # isnir ağı katmalnları için
import numpy as np  
import pandas as pd
...
# Giriş katmanındaki virgül hatasını düzelttik
input_layer = Input(shape=(data_x_train_scaled.shape[1],), name='Input_Layer')



# units değerlerini sayıya çevirdik
